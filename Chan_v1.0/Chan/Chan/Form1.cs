...
namespace Chan
{
    public partial class Form1 : Form
    {
        ...
        private Int32 iKGrade = 240;
        private Int32 iGraphiceGrade = 1;
        ...
        private string strStockNameList;
        private string strCurrentPath = System.Environment.CurrentDirectory;

        public Form1()
        {
            InitializeComponent();
            //textBox2.Text = "C:\\new_tdx\\vipdoc";
            //textBox2.Text = "D:\\虚拟机共享\\new_tdx\\vipdoc";
            textBox2.Text = "D:\\alpes_work\\tdx\\tdx\\vipdoc";
            
            label2.Text = "";
            strStockNumber = "999999";
            //strStockNumber = "600362";
            ...
            this.textBox2.KeyDown += new KeyEventHandler(this.ChangeGraphicGrade);
            this.textBox2.KeyDown += new KeyEventHandler(this.ChangeKGrade);

            //读取StockList.txt
            if (false != File.Exists(this.strCurrentPath + "\\StockList.txt"))
                strStockNameList = File.ReadAllText(this.strCurrentPath + "\\StockList.txt", Encoding.Default);
        ...
        private void RefreshWindow(object sender, System.EventArgs e)
        {
            ...
            textBox2.Location = new Point(193, this.ClientSize.Height - 23);
        ...
        private void UpdatePaint()
        {
            ...
            label2.Text = this.strStockNumber + " " + GetStockName();
        ...
        {
            if (-1 == this.strStockNameList.IndexOf(this.strStockNumber))
                return null;
            return this.strStockNameList.Substring(this.strStockNameList.IndexOf(this.strStockNumber) + 7, 4);
        }
        ...
        public SingalKData[] GetKDataArray(Int32 iKNumber, Int32 iKGrade)
        {
            ...
            switch (iKGrade)
            {
                ...
                case 240:
                    ...
                    {
                        KDataArray[iCount].iOpen = BitConverter.ToInt32(byTempBuffer, 4 + iOffset + 32 * iCount) / 10;
                        KDataArray[iCount].iHigh = BitConverter.ToInt32(byTempBuffer, 8 + iOffset + 32 * iCount) / 10;
                        KDataArray[iCount].iLow = BitConverter.ToInt32(byTempBuffer, 12 + iOffset + 32 * iCount) / 10;
                        KDataArray[iCount].iClose = BitConverter.ToInt32(byTempBuffer, 16 + iOffset + 32 * iCount) / 10;
                    }
